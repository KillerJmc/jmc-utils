...
public class CompareTest {
    ...
    public void ArrayTest() {
        ...
        Assert.assertTrue(Compare.lt(a, 0, 2));
        Assert.assertFalse(Compare.eq(a, 2, 0));
        Assert.assertTrue(Compare.le(a, 0, 2));
        Assert.assertFalse(Compare.ge(a, 0, 2));

        var a2 = Array.of(1.0, 2.0, 3.0);
        Assert.assertFalse(Compare.lt(a2, 2, 0));
    }
}
